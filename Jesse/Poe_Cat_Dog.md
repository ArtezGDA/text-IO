```
Last login: Mon Dec 21 12:17:46 on ttys000
[JesseWensing@admins-MBP: ~]% cat vol* | grep -ci 'cat'                    [52]
581
[JesseWensing@admins-MBP: ~]% cat vol* | grep -ci 'dog'                    [53]
91
[JesseWensing@admins-MBP: ~]% cat vol* | grep -ci 'horror'                 [54]
127
[JesseWensing@admins-MBP: ~]% cat vol* | grep -n 'horror'                  [55]
