...
screen.addstr( 2, 1, "|/")
screen.addstr( 3, 0, "voor", curses.A_BOLD)

time.sleep(1)
screen.refresh()
screen.addstr( 2, 6, "|/")#raar
...
#wanneer hij rond is moet hij weer loopen, of je laat hem stoppen na 1,5 minuut wat ook leuk is is wanneer je er dans muziek onder kan zetten
screen.getch()
curses.endwin()
